...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<WakeUp-request> is deprecated: use rasa_ros-srv:WakeUp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<WakeUp-response> is deprecated: use rasa_ros-srv:WakeUp-response instead.")))
