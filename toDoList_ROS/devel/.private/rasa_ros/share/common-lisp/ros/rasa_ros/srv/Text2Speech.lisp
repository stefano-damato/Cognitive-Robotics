...
(cl:defmethod cl:initialize-instance :after ((m <Text2Speech-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Text2Speech-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<Text2Speech-request> is deprecated: use rasa_ros-srv:Text2Speech-request instead.")))

(cl:ensure-generic-function 'speech-val :lambda-list '(m))
(cl:defmethod speech-val ((m <Text2Speech-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasa_ros-srv:speech-val is deprecated.  Use rasa_ros-srv:speech instead.")
  (speech m))
...
(cl:defmethod cl:initialize-instance :after ((m <Text2Speech-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Text2Speech-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<Text2Speech-response> is deprecated: use rasa_ros-srv:Text2Speech-response instead.")))

(cl:ensure-generic-function 'ack-val :lambda-list '(m))
(cl:defmethod ack-val ((m <Text2Speech-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasa_ros-srv:ack-val is deprecated.  Use rasa_ros-srv:ack instead.")
  (ack m))
