...
(cl:defmethod cl:initialize-instance :after ((m <Rest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<Rest-request> is deprecated: use rasa_ros-srv:Rest-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Rest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<Rest-response> is deprecated: use rasa_ros-srv:Rest-response instead.")))
