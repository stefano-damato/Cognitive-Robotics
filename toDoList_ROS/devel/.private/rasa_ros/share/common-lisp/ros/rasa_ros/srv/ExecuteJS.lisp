...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteJS-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteJS-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<ExecuteJS-request> is deprecated: use rasa_ros-srv:ExecuteJS-request instead.")))

(cl:ensure-generic-function 'js-val :lambda-list '(m))
(cl:defmethod js-val ((m <ExecuteJS-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasa_ros-srv:js-val is deprecated.  Use rasa_ros-srv:js instead.")
  (js m))
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteJS-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteJS-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<ExecuteJS-response> is deprecated: use rasa_ros-srv:ExecuteJS-response instead.")))
