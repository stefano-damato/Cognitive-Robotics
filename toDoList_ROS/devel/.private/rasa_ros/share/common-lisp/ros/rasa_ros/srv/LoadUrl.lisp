...
(cl:defmethod cl:initialize-instance :after ((m <LoadUrl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadUrl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<LoadUrl-request> is deprecated: use rasa_ros-srv:LoadUrl-request instead.")))

(cl:ensure-generic-function 'url-val :lambda-list '(m))
(cl:defmethod url-val ((m <LoadUrl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rasa_ros-srv:url-val is deprecated.  Use rasa_ros-srv:url instead.")
  (url m))
...
(cl:defmethod cl:initialize-instance :after ((m <LoadUrl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadUrl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rasa_ros-srv:<LoadUrl-response> is deprecated: use rasa_ros-srv:LoadUrl-response instead.")))
